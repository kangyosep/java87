...
<body>
    ...
    <div class="detailGrid">
        ...
        <div>
            <c:if test="${!empty style.position1x}"><div class="position1" id="position1" style="position:absolute; left:${style.position1x+20}px; top:${style.position1y+70}px;"><p class="pTagPrice">${style.priceInfo1}</p></div></div></c:if>
            <c:if test="${!empty style.position2x}"><div class="position1" id="position2" style="position:absolute; left:${style.position2x+20}px; top:${style.position2y+70}px;"><p class="pTagPrice">${style.priceInfo2}</p></div></div></c:if>
            <c:if test="${!empty style.position3x}"><div class="position1" id="position3" style="position:absolute; left:${style.position3x+20}px; top:${style.position3y+70}px;"><p class="pTagPrice">${style.priceInfo3}</p></div></div></c:if>
            <c:if test="${!empty style.position4x}"><div class="position1" id="position4" style="position:absolute; left:${style.position4x+20}px; top:${style.position4y+70}px;"><p class="pTagPrice">${style.priceInfo4}</p></div></div></c:if>
            <c:if test="${!empty style.position5x}"><div class="position1" id="position5" style="position:absolute; left:${style.position5x+20}px; top:${style.position5y+70}px;"><p class="pTagPrice">${style.priceInfo5}</p></div></div></c:if>
            
            <c:if test="${!empty style.position1x}"><div class="position2" id="info1" style="position:absolute; left:${style.position1x+20}px; top:${style.position1y+70}px;"><p class="pTagInfo">${style.styleInfo1}</p></div></div></c:if>
            <c:if test="${!empty style.position2x}"><div class="position2" id="info2" style="position:absolute; left:${style.position2x+20}px; top:${style.position2y+70}px;"><p class="pTagInfo">${style.styleInfo2}</p></div></div></c:if>
            <c:if test="${!empty style.position3x}"><div class="position2" id="info3" style="position:absolute; left:${style.position3x+20}px; top:${style.position3y+70}px;"><p class="pTagInfo">${style.styleInfo3}</p></div></div></c:if>
            <c:if test="${!empty style.position4x}"><div class="position2" id="info4" style="position:absolute; left:${style.position4x+20}px; top:${style.position4y+70}px;"><p class="pTagInfo">${style.styleInfo4}</p></div></div></c:if>
            <c:if test="${!empty style.position5x}"><div class="position2" id="info5" style="position:absolute; left:${style.position5x+20}px; top:${style.position5y+70}px;"><p class="pTagInfo">${style.styleInfo5}</p></div></div></c:if>
