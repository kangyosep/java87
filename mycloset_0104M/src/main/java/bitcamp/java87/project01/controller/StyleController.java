...
public class StyleController {
  ...
  public ModelAndView prepareDelete(ModelAndView modelAndView,HttpServletRequest request) throws Exception{
	  
	  System.out.println("  >>  /style/prepareDelete : GET");
	  int styleNo = Integer.parseInt(request.getParameter("styleNo"));
	  Style style = styleService.getStyle(styleNo);
	  style.setStyleLike("delete");
	  modelAndView.addObject("style", style);
	  System.out.println("    제발 나올거다 !! "+style.getStyleLike());
	  System.out.println("   제발 나와라 뿅뿅  모델앤뷰 디벅 "+modelAndView);
  ...
  @ResponseBody
  public String deleteStyle(ModelAndView modelAndView,HttpServletRequest request) throws Exception{
  ...
  @ResponseBody
  public String detailView(HttpServletRequest request, @RequestParam() int styleNo) throws Exception{
	  
	  System.out.println(" styleController >> detailView ");
	  System.out.println(" 디버깅 : "+styleNo);
	  Style style = styleService.getStyle(styleNo);
	  System.out.println("  style 디버깅 : "+style);
