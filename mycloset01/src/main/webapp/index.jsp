...
<html class=''>
<head>
<!-- <link rel="canonical" href="http://codepen.io/ritz078/pen/wMPRzr" /> -->
...
<link rel="stylesheet" href="front/css/docs.css">
 -->
</head>
<body>
	<header>
		<div class="header-top clearfix">
			<h1 class="a">myCloset.Logo</h1>
			<a class="l-right toggle-menu" href="#"> <i></i> <i></i> <i></i>
			</a>
		</div>
	</header>
								...
								<div class="row">
									<div class="col-lg-12">
										...
										<div class="faceBookBtn" style="display:block" >
									 	<button class="loginBtn loginBtn--facebook" onclick="FB.login();">
