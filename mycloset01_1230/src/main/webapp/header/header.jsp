...
<%-- <%@page import="bitcamp.java87.project01.domain.User"%>
		...
		<header id="header">
			...
			<nav id="hd-nav">
				...
				<ul id="hd-gnb">
				    ...
				    <!-- 업로드 -->
					<li>
					   <img id="fileUpload" class="hd-icon-upload"
						...
						<ul class="hd-gnb-sub hd-msg">
							...
							<div class="hd-msg-tab">
								    ...
								    <span class="hd-tab-msg"> 
									    <a href="#" onclick="openChat(${user.user_no})"> Message </a>
									</span>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<div class="filebox bs3-primary preview-image">
							<input id="upload-name" class="form-control" value="파일선택" disabled="disabled" style="margin-right: 5px; width: 270px; margin-bottom: 6px; float:left;">
							<label class="btn btn-default" for="input_file">사진찾기</label>
							<input type="file" onchange="openFile(event)" id="input_file" class="upload-hidden"	name="fileUpload" style="display:none;" >
						</div>
				...
				<div class="modal-content2">
					<div class="modal-header2">
						...
						<div class="modal-body2">
							...
							<input type="text" style="width:400px;" class="form-control" placeholder="제목을 입력하세요."
							...
							<div class="preview-image2" id="previewImage2">
								...
								<label style="float:left; margin-left:-340px; margin-top:10px;">내용</label>
								<textarea name="styleDesc" id="memo" style="width:400px;" class="form-control" rows="5" placeholder="#을 이용하여 해시태그를 등록 해보세요!                                 예)  #청바지 랑 #셔츠 새로 샀어요!"></textarea>

								<hr>

								<button class="btn btn-default submitbuttom"
									id="uploadSubmitBtn" style="margin-top:10px; margin-left: 84%;">업로드</button>
